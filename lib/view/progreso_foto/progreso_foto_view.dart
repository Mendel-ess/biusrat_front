...
import 'package:biusrat_app_fitness/view/progreso_foto/comparar_view.dart';
import 'package:flutter/material.dart';

class ProgresoFotoView extends StatefulWidget {
  const ProgresoFotoView({super.key});

  @override
  State<ProgresoFotoView> createState() => _ProgresoFotoViewState();
}

class _ProgresoFotoViewState extends State<ProgresoFotoView> {
  List photoArr = [
    {
      "time": "2 June",
      "photo": [
