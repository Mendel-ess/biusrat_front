...
import 'package:biusrat_app_fitness/common_widget/entrenamiento.dart';
import 'package:biusrat_app_fitness/common_widget/round_boton.dart';
import 'package:biusrat_app_fitness/view/home/actividad_tracker_view.dart';
import 'package:biusrat_app_fitness/view/home/fin_entrenamiento_view.dart';
import 'package:biusrat_app_fitness/view/home/notificacion_view.dart';
...
class _HomeViewState extends State<HomeView> {
  List lastWorkoutArr = [
    ...
    {
      "name": "Entrenamiento Tren Inferior",
    ...
    {
      "name": "Entrenamiento Abdominales",
      ...
      LineChartBarData(
        ...
        belowBarData: BarAreaData(
          ...
          gradient: LinearGradient(colors: [
            ...
            BColor.primaryColor1.withOpacity(0.1),
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(color: BColor.black, fontSize: 14),
                        )
                      ],
                    ),
                    IconButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const NotificacionView(),
                            ),
                          );
                        },
                        icon: Image.asset(
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        ...
                                        SimpleCircularProgressBar(
                                          ...
                                          backStrokeWidth: 10,
                                          progressColors: BColor.primaryG,
                      ...
                      return InkWell(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    const FinEntrenamientoView(),
                              ),
                            );
                          },
                          child: Entrenamiento(wObj: wObj));
                    }),
                SizedBox(
                  height: media.width * 0.1,
                ),
  ...
  List<PieChartSectionData> showingSections() {
    return List.generate(
      2,
      (i) {
        var color0 = BColor.secondaryColor1;
