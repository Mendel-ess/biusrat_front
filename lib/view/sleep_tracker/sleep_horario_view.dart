...
import 'package:biusrat_app_fitness/view/sleep_tracker/sleep_alarma_view.dart';
import 'package:calendar_agenda/calendar_agenda.dart';

import 'package:flutter/material.dart';
import 'package:simple_animation_progress_bar/simple_animation_progress_bar.dart';

class SleepHorarioView extends StatefulWidget {
  const SleepHorarioView({super.key});

  @override
  State<SleepHorarioView> createState() => _SleepHorarioViewState();
}

class _SleepHorarioViewState extends State<SleepHorarioView> {
            ...
            Column(
              ...
              children: [
                ...
                Container(
                    ...
                    decoration: BoxDecoration(
                        gradient: LinearGradient(colors: [
                          BColor.secondaryColor2.withOpacity(0.4),
                          BColor.secondaryColor1.withOpacity(0.4)
                        ]),
                        borderRadius: BorderRadius.circular(20)),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
      ...
      floatingActionButton: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => SleepAlarmaView(
